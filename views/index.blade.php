@extends('layouts.app') 
    ...
    <main class="main">
        ...
        <div class="main__availability">
            <form class="main__availability--form" action="rooms.php" method="GET">
                ...
                <button type="submit" class="main__availability--form--bt" id="availabilityForm">CHECK AVAILABILITY</button>
            </form>
        </div>
