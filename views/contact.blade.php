@extends('layouts.app') 
    ...
    <main class="main__contact">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3037.1327030933285!2d-3.7172707234691624!3d40.42806035494868!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd4229fc15efcb09%3A0xb0036150b0cd3867!2sOXYGEN%20Academy%20%7C%20Full%20Stack%20Bootcamps!5e0!3m2!1ses!2ses!4v1700066841065!5m2!1ses!2ses" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="main__contact--map"></iframe>
            ...
            <form class="main__contact--data" action="contact.php" method="POST">
                <input type="text" name="fullname" class="main__contact--data--element" placeholder="Your full name" required />
                <input type="text" name="phone" class="main__contact--data--element" placeholder="Add phone number" required />
                <input type="text" name="email" class="main__contact--data--element" placeholder="Enter email address" required />
                <input type="text" name="subject" class="main__contact--data--element" placeholder="Enter subject" required />
                <textarea name="message" id="" class="main__contact--data--element--textarea" cols="30" rows="10" placeholder="Enter message" required></textarea>
                <button type="submit" class="main__contact--data--send" id="formContact">SEND</button>
            </form>
    </main>
    @endsection