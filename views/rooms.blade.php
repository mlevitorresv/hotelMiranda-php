        ...
        <div class="main__rooms--elements">
            <div class="main__rooms--elements--element" onclick="location.href='./roomDetails.html'">
                ...
                <div class="main__rooms--elements--element--info">
                    ...
                    <h3 class="main__rooms--elements--element--info--title">Minimal Duplex Room</h3>
                    <p class="main__rooms--elements--element--info--desc">Lorem ipsum dolor sit amet, consectetur adipi sicing elit, sed do eiusmod tempor.</p>
                </div>
                <div class="main__rooms--elements--element--booking">
                    <p class="main__rooms--elements--element--booking--price">$345/Night</p>
